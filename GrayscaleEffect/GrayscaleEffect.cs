...
{
    //Code taken from: http://bursjootech.blogspot.de/2008/06/grayscale-effect-pixel-shader-effect-in.html
    public class GrayscaleEffect : ShaderEffect
    {
        private static PixelShader _pixelShader = new PixelShader() { UriSource = Global.MakePackUri("GrayscaleEffect.ps") };
